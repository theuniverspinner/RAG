...
const response14 = await customQueryEngine.query({
  query: 'Bbased on the salient themes found, what do you think is the best way to move forward for the author?'
})
